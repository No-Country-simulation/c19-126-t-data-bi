...
# ========== Carga de datos ==========
df = pd.read_csv('c19-126-t-data-bi/files/datasets/input/forecasting/V.csv')
...
# Nuevo código para guardar y_test_pred con fechas correspondientes
output_dir = 'c19-126-t-data-bi/files/datasets/output'
os.makedirs(output_dir, exist_ok=True)

# Obtener las fechas correspondientes del conjunto de prueba
dates = df[-test_size:]['Date'].iloc[window_size:].reset_index(drop=True)
...
input_filename = os.path.basename('V')
output_filename = f"predicciones_de_{os.path.splitext(input_filename)[0]}.csv"
